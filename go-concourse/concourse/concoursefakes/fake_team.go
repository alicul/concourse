...
type FakeTeam struct {
	...
	SetWebhookStub        func(concourse.WebhookConfig) (atc.Webhook, error)
	setWebhookMutex       sync.RWMutex
	setWebhookArgsForCall []struct {
		arg1 concourse.WebhookConfig
	}
...
func (fake *FakeTeam) SetWebhook(arg1 concourse.WebhookConfig) (atc.Webhook, error) {
...
func (fake *FakeTeam) SetWebhookCalls(stub func(concourse.WebhookConfig) (atc.Webhook, error)) {
	fake.setWebhookMutex.Lock()
	defer fake.setWebhookMutex.Unlock()
	fake.SetWebhookStub = stub
}

func (fake *FakeTeam) SetWebhookArgsForCall(i int) concourse.WebhookConfig {
	fake.setWebhookMutex.RLock()
	defer fake.setWebhookMutex.RUnlock()
