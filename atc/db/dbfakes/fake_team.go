...
type FakeTeam struct {
	...
	SaveWebhookStub        func(string, string, string) (db.Webhook, error)
...
func (fake *FakeTeam) FindCheckContainersCalls(stub func(lager.Logger, atc.PipelineRef, string) ([]db.Container, map[int]time.Time, error)) {
	fake.findCheckContainersMutex.Lock()
	defer fake.findCheckContainersMutex.Unlock()
	fake.FindCheckContainersStub = stub
}

func (fake *FakeTeam) FindCheckContainersArgsForCall(i int) (lager.Logger, atc.PipelineRef, string) {
	fake.findCheckContainersMutex.RLock()
	defer fake.findCheckContainersMutex.RUnlock()
...
func (fake *FakeTeam) FindWorkersForResourceCacheCallCount() int {
...
func (fake *FakeTeam) FindWorkersForResourceCacheReturnsOnCall(i int, result1 []db.Worker, result2 error) {
	fake.findWorkersForResourceCacheMutex.Lock()
	defer fake.findWorkersForResourceCacheMutex.Unlock()
	fake.FindWorkersForResourceCacheStub = nil
...
func (fake *FakeTeam) SaveWebhook(arg1 string, arg2 string, arg3 string) (db.Webhook, error) {
	...
	fake.recordInvocation("SaveWebhook", []interface{}{arg1, arg2, arg3})
...
func (fake *FakeTeam) SaveWebhookCalls(stub func(string, string, string) (db.Webhook, error)) {
	fake.saveWebhookMutex.Lock()
	defer fake.saveWebhookMutex.Unlock()
	fake.SaveWebhookStub = stub
}

func (fake *FakeTeam) SaveWebhookArgsForCall(i int) (string, string, string) {
	fake.saveWebhookMutex.RLock()
	defer fake.saveWebhookMutex.RUnlock()
