...
type FakeSetPipelineStepDelegate struct {
	...
	CheckRunSetPipelinePolicyStub        func(*atc.Config, string) error
...
func (fake *FakeSetPipelineStepDelegate) CheckRunSetPipelinePolicy(arg1 *atc.Config, arg2 string) error {
...
func (fake *FakeSetPipelineStepDelegate) CheckRunSetPipelinePolicyCalls(stub func(*atc.Config, string) error) {
	fake.checkRunSetPipelinePolicyMutex.Lock()
	defer fake.checkRunSetPipelinePolicyMutex.Unlock()
	fake.CheckRunSetPipelinePolicyStub = stub
}

func (fake *FakeSetPipelineStepDelegate) CheckRunSetPipelinePolicyArgsForCall(i int) (*atc.Config, string) {
	fake.checkRunSetPipelinePolicyMutex.RLock()
	defer fake.checkRunSetPipelinePolicyMutex.RUnlock()
